...
Mostra l'intera storia dei commit visualizzata nel pager
(vedere \ref{configurazione}) di default.
Le lunghe serie di caratteri sono i commit \textbf{hash}, univoci
per ogni commit.
...
\subsection{Cercare nella storia dei commit}
...
\begin{itemize}
    ...
    \item \href{https://stackoverflow.com/questions/2304087/what-is-head-in-git}{cos'è head}
    \item \href{https://www.git-tower.com/learn/git/faq/detached-head-when-checkout-commit}{deatached head}
