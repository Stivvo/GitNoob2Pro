...
HEAD si trova ora a 8b10ce3 refactoring server class
\end{verbatim}
...
Se si ritorna subito con un checkout sul proprio branch (in questo caso master),
che contiene ancora i commit che vogliamo eliminare, un push li riporterebbe sul 
repository remoto.
Quindi si può clonare nuovamente il progetto (è sempre la soluzione peggiore)
oppure utilizzare reset: 
