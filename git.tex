...
(ad esempio \code{git pull amanjot}).
...
è scritto in markdown, viene quindi compilato dal GitHub per dare un aspetto
gradevole alla pagina iniziale di un repository.
...
\subsection{generale}
\begin{itemize}
    \item \href{https://github.com/Stivvo/GitNoob2Pro}{questa stessa dispensa su
        Github}
    ...
    \item \href{https://git-scm.com/book/en/v2}{pro git (libro completo)}
