...
commit diversi dello stesso branch) come ad esempio quando bisogna unire nel branch principale
...
(HEAD, vedere \reff{heads}) e quella dell'altro, identificata dal codice hash
(vedere \reff{log}) del commit che ha rinominato la classe in SecondClass.
